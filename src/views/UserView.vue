<template>
    ...
    <h1 v-if="historyDetail.length == 0" class="block m-4 text-2xl font-bold leading-tight text-teal-800 uppercase">No
        History</h1>
    <div class="mx-4" v-if="historyDetail.length > 0">
        ...
        <div class="flex flex-row justify-center m-4">
            <base-table :headline="headline" :data="historyDetail">
            </base-table>
            <table class="text-sm text-left text-gray-800 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700" v-for="data in historyDetail"
                        :key="data.id">
                        <td class="px-6 py-4">
                            <button :data-bookId="data.id" @click="bookReturn"
